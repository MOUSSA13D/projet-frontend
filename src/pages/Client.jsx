  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-xl font-montserrat">Chargement des clients...</div>
      </div>
    )
  }
    ...
    <div className="flex-row justify-center items-center w-full min-h-screen pt-10 pb-20 sm:py-10 p-2 sm:pl-14">
      ...
      <div className="mt-5 mr-5">
        ...
        <ConfirmationModal
          ...
          message={`Êtes-vous sûr de vouloir supprimer ${selectedUsers.length} client(s) ?`}
          actionType="delete"
        />
        ...
        <ConfirmationModal
          ...
          title={multiActionType === 'block' ? 'Bloquer les clients ?' : 'Débloquer les clients ?'}
          message={`Êtes-vous sûr de vouloir ${multiActionType === 'block' ? 'bloquer' : 'débloquer'} ${selectedUsers.length} client(s) ?`}
